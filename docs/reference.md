...
The public API lives at the module root (`github.com/go-ruby-rss/rss`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `rss`, while the surface follows
...
```go
import "github.com/go-ruby-rss/rss"
```
...
- **[pkg.go.dev/github.com/go-ruby-rss/rss](https://pkg.go.dev/github.com/go-ruby-rss/rss)**

The module's [README](https://github.com/go-ruby-rss/rss#readme) carries worked
