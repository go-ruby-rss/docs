...
`go-ruby-rss/rss` reimplements Ruby's `rss` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-rss/rss` directly, with no Ruby runtime;
