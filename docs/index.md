# go-ruby-rss documentation

**Pure-Go, MRI-4.0.5-faithful Ruby rss (no cgo)**

`go-ruby-rss/rss` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `rss`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-rss/rss`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `rss`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`rss`](https://github.com/go-ruby-rss/rss) | the library — Ruby's `rss` in pure Go |
| [`docs`](https://github.com/go-ruby-rss/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-rss.github.io`](https://github.com/go-ruby-rss/go-ruby-rss.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-rss/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-rss/rss](https://github.com/go-ruby-rss/rss).
